...
class settings(_object):
    ...
    USE_ELEMENT_NAMES = _ifcopenshell_wrapper.settings_USE_ELEMENT_NAMES
    USE_ELEMENT_GUIDS = _ifcopenshell_wrapper.settings_USE_ELEMENT_GUIDS
    USE_MATERIAL_NAMES = _ifcopenshell_wrapper.settings_USE_MATERIAL_NAMES
    CENTER_MODEL = _ifcopenshell_wrapper.settings_CENTER_MODEL
...
class iterator_single_precision(_object):
    ...
    def includeEntities(self, entities):
        return _ifcopenshell_wrapper.iterator_single_precision_includeEntities(self, entities)

    def excludeEntities(self, entities):
        return _ifcopenshell_wrapper.iterator_single_precision_excludeEntities(self, entities)

    def include_entity_names(self, names):
        return _ifcopenshell_wrapper.iterator_single_precision_include_entity_names(self, names)

    def exclude_entity_names(self, names):
        return _ifcopenshell_wrapper.iterator_single_precision_exclude_entity_names(self, names)
    __swig_getmethods__["wildcard_string_to_regex"] = lambda x: _ifcopenshell_wrapper.iterator_single_precision_wildcard_string_to_regex
    if _newclass:
        wildcard_string_to_regex = staticmethod(_ifcopenshell_wrapper.iterator_single_precision_wildcard_string_to_regex)
...
def iterator_single_precision_wildcard_string_to_regex(str):
    return _ifcopenshell_wrapper.iterator_single_precision_wildcard_string_to_regex(str)
iterator_single_precision_wildcard_string_to_regex = _ifcopenshell_wrapper.iterator_single_precision_wildcard_string_to_regex
...
class iterator_double_precision(_object):
    ...
    def includeEntities(self, entities):
        return _ifcopenshell_wrapper.iterator_double_precision_includeEntities(self, entities)

    def excludeEntities(self, entities):
        return _ifcopenshell_wrapper.iterator_double_precision_excludeEntities(self, entities)

    def include_entity_names(self, names):
        return _ifcopenshell_wrapper.iterator_double_precision_include_entity_names(self, names)

    def exclude_entity_names(self, names):
        return _ifcopenshell_wrapper.iterator_double_precision_exclude_entity_names(self, names)
    __swig_getmethods__["wildcard_string_to_regex"] = lambda x: _ifcopenshell_wrapper.iterator_double_precision_wildcard_string_to_regex
    if _newclass:
        wildcard_string_to_regex = staticmethod(_ifcopenshell_wrapper.iterator_double_precision_wildcard_string_to_regex)
...
def iterator_double_precision_wildcard_string_to_regex(str):
    return _ifcopenshell_wrapper.iterator_double_precision_wildcard_string_to_regex(str)
iterator_double_precision_wildcard_string_to_regex = _ifcopenshell_wrapper.iterator_double_precision_wildcard_string_to_regex
...
class element_single_precision(_object):
    ...
    def __init__(self, settings, id, parent_id, name, type, guid, context, trsf):
        this = _ifcopenshell_wrapper.new_element_single_precision(settings, id, parent_id, name, type, guid, context, trsf)
        try:
            self.this.append(this)
        except:
            self.this = this
...
class element_double_precision(_object):
    ...
    def __init__(self, settings, id, parent_id, name, type, guid, context, trsf):
        this = _ifcopenshell_wrapper.new_element_double_precision(settings, id, parent_id, name, type, guid, context, trsf)
        try:
            self.this.append(this)
        except:
            self.this = this
